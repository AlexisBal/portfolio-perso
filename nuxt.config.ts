    ...
    app: {
        ...
        head: {
            ...
            meta: [
              ...
              { hid: 'og:image', name: 'og:image', content: 'https://alexis.balayre.xyz/preview.png' },
              ...
              { hid: 'twitter:image', name: 'twitter:image', content: 'https://alexis.balayre.xyz/preview.png' },
            ...
            link: [
              ...
              { rel: 'canonical', href: 'https://alexis.balayre.xyz/' },
            ]
        },
    },
